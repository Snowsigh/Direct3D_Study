...
bool KCamera::Init(TVector3 vCameraPos, TVector3 vTargetPos, float vDistance)
{
    CreateViewMatrix(vCameraPos, vTargetPos);
    CreateProjMatrix(1.0f, vDistance, TBASIS_PI * 0.5f, (float)g_rtClient.right / (float)g_rtClient.bottom);
    return true;
}
